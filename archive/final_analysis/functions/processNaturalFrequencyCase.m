function [avg_period, std_period, frequency, freq_uncertainty] = processNaturalFrequencyCase(filename, dataFolder)
    % processNaturalFrequencyCase
    ...
    [avg_period, std_period, frequency, freq_uncertainty] = analyzePeriods(time, position_centered);
end
