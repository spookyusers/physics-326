...
[~, idx] = max(results_table.Amplitude); % find index from table
highest_amp_frequency = results_table.Frequency(idx);
disp(['The frequency with the highest amplitude is: ', ...
    num2str(highest_amp_frequency), ' Hz']);
